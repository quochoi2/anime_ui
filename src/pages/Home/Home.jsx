                ...
                <div className="row">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-4">
                    <div className="btn__all">
                      <Link to={"/trend"} className="primary-btn">
                  ...
                  <div className="col-lg-4 col-md-6 col-sm-6">
                    <div className="product__item">
                      ...
                      <div className="product__item__text">
                        ...
                        <h5>
                          <a href="#">
                            Fate/stay night Movie: Heavens Feel - II. Lost
                          </a>
                        </h5>
                      </div>
                    </div>
                  ...
                  <div className="product__sidebar__comment__item">
                    <div className="product__sidebar__comment__item__pic">
                      <img
                        ...
                        alt
                        style={{
                          backgroundImage: 'url("/img/sidebar/comment-1.jpg")',
                        }}
                      />
                    </div>
                  ...
                  <div className="product__sidebar__comment__item">
                    <div className="product__sidebar__comment__item__pic">
                      <img
                        ...
                        alt
                        style={{
                          backgroundImage: 'url("/img/sidebar/comment-3.jpg")',
                        }}
                      />
                    </div>
                    <div className="product__sidebar__comment__item__text">
                  ...
                  <div className="product__sidebar__comment__item">
                    <div className="product__sidebar__comment__item__pic">
                      <img
                        ...
                        alt
                        style={{
                          backgroundImage: 'url("/img/sidebar/comment-4.jpg")',
                        }}
                      />
                    </div>
                    <div className="product__sidebar__comment__item__text">
